    ...
    return /* @__PURE__ */ React.createElement(
      ...
      fields.map((field) => {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: field.name, className: "mb-4 text-start" }, field.type !== "checkbox" && field.type !== "rating" && /* @__PURE__ */ React.createElement(
          ...
          option.label
        ))), field.type === "checkbox" && /* @__PURE__ */ React.createElement(
          "label",
          {
          ...
          field.label
        ), field.type === "file" && /* @__PURE__ */ React.createElement(
          "input",
          {
            id: field.name,
            type: "file",
        ...
        ), field.type === "rating" && /* @__PURE__ */ React.createElement("div", { className: `flex flex-col gap-1` }, /* @__PURE__ */ React.createElement(
          "label",
          {
            className: `mb-1 block text-sm font-medium text-gray-900 ${labelClassName}`
          },
          field.label
        ), /* @__PURE__ */ React.createElement("div", { className: `flex gap-1 ${ratingClassName}` }, [...Array(field.max || 5)].map((_, i) => {
          const value = i + 1;
...
export {
  ReusableForm_default as default
};
