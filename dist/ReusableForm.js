    ...
    return /* @__PURE__ */ import_react.default.createElement(
      ...
      fields.map((field) => {
        ...
        return /* @__PURE__ */ import_react.default.createElement("div", { key: field.name, className: "mb-4 text-start" }, field.type !== "checkbox" && field.type !== "rating" && /* @__PURE__ */ import_react.default.createElement(
          ...
          option.label
        ))), field.type === "checkbox" && /* @__PURE__ */ import_react.default.createElement(
          "label",
          {
            className: `flex items-center gap-2 text-sm font-medium text-gray-900 ${checkboxClassName}`
          },
          /* @__PURE__ */ import_react.default.createElement(
            "input",
            {
          ...
          field.label
        ), field.type === "file" && /* @__PURE__ */ import_react.default.createElement(
          "input",
          {
            id: field.name,
            type: "file",
        ...
        ), field.type === "rating" && /* @__PURE__ */ import_react.default.createElement("div", { className: `flex flex-col gap-1` }, /* @__PURE__ */ import_react.default.createElement(
          "label",
          {
            className: `mb-1 block text-sm font-medium text-gray-900 ${labelClassName}`
          },
          field.label
        ), /* @__PURE__ */ import_react.default.createElement("div", { className: `flex gap-1 ${ratingClassName}` }, [...Array(field.max || 5)].map((_, i) => {
          const value = i + 1;
...
var ReusableForm_default = ReusableForm;
